...
def generate_full_report(place):
    ...
    if not place:
        print("ERROR: Please provide a place name as a command line argument (e.g., python diagnose_pipeline.py טבריה)")
        return
    ...
    if not os.path.exists(report_path):
        print(f"\n--- ❌ ERROR: Diagnostic report not found at {report_path} ---")
    ...
    print("\n## 📊 Overall Matching Status Counts")
    print("-----------------------------------")
    ...
    print("\n## ✅ Successfully Matched Streets (Final LAMAS ID Assigned)")
    ...
    print("\n## ❌ Unmatched / Ambiguous Streets (NEEDS_ATTENTION)")
